...
?>
    ...
    <div class="clearfix">
        ...
        if ($p_tombol == "KIRIM") {
            if (
                $p_idcuti == "" || $p_tglawal == "" || $p_tglakhir == "" || $p_lama == ""
                || $p_alasan == ""
            ) {
                        ...
                        if ($tahunkerja == 0) {
                            ...
                            if ($p_lama < $rowjatah[0]) {
                                if ($j_sisa_cuti['sisacuti'] == 0) {
                                    $q_daftar = mysqli_query($mysqli, "INSERT INTO ajuancuti (kdcuti,id,id_cuti,tgl_pengajuan,tgl_mulai,tgl_akhir,lama_cuti,alasan,kd_approve,nip,jab_atasan) VALUES (0,'$p_id_d','$p_idcuti',NOW(),'$p_tglawal','$p_tglakhir','$p_lama','$p_alasan','3','$p_nip','$jab_atasan')");
    ...
    <div id="user-profile-1" class="user-profile row">
        ...
        <div class='infobox-data'>
            <div class='infobox-content'>Jatah Cuti</div>
    ...
    * Cuti Tahunan
    ...
    WHERE tbl_user.nip=pegawai.nip and pegawai.id_jab=jabatan.kode and pegawai.id=$id_daf");
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content profile-edit-tab-content">
                        <div id="edit-basic" class="tab-pane in active">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-first">Tempat Tugas</label>

                                <div class="col-sm-9">
                                    <input class="col-xs-7 col-sm-5" type="text" id="tt" placeholder="tt" disabled="disabled" name="tt" value="<?php echo $c['klien']; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-first">Users</label>
                            ...
                            <div class="form-group" hidden>
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-date">Tanggal Pengajuan </label>
                            ...
                            <div class="clearfix form-actions">
                                ...
                                <tr>
                                    <td></td>
                                    <td><input class="width-35 pull-right btn btn-sm btn-primary" type="submit" name="kirim_daftar" value="<?php echo $p_submit; ?>"></td>
                                </tr>
        ...
        <div id="approved" class="tab-pane">
            ...
            FROM ajuancuti,pegawai,tbl_cuti,status_app where ajuancuti.id=pegawai.id and ajuancuti.id_cuti=tbl_cuti.id_cuti and ajuancuti.kd_approve=status_app.kd_approve and ajuancuti.id=$id_daf  ORDER BY ajuancuti.tgl_pengajuan ASC") or die(mysqli_error($mysqli));
