...
$p_penempatan  	= isset($_POST['penempatan']) ? $_POST['penempatan'] : NULL;
...
if ($tb_act == "SIMPAN") {
	...
	if ($resultcek > 0) {
		...
		if ($resultceknip > 0) {
			$q_absensi	= mysqli_query($mysqli, "INSERT INTO absensi (id_absensi,nip,penempatan,id_abs,tanggal_absen,jam_in,jam_out,status_masuk,status_keluar,terlambat,pulangcepat) 
										VALUES  ('','$p_id_nip','$p_penempatan','$p_shift','$p_tgl_absen','$p_jam_in','$p_jam_out','Y','Y','$telat','$pulang_cepat')");
					...
					<div class="form-group">
						...
						<div class="col-xs-3 col-sm-2">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="penempatan" id="search_keyword_penempatan" oninput="getklien()" readonly>
								<span id="result"></span>
							</div>
						</div>
					</div>
