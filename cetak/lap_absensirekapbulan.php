...
while ($data1 = mysqli_fetch_row($query)) {
	...
	if ($_POST['bulan'] == '01') {
		...
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN FEBRUARI TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '03') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN MARET TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '04') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN APRIL TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '05') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN MEI TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '06') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN JUNI TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '07') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN JULI TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '08') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN AGUSTUS TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '09') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN SEPTEMBER TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '10') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN OKTOBER TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '11') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN NOVEMBER TAHUN  " . $_POST['tahun'] . " ";
	} else if ($_POST['bulan'] == '12') {
		$lap = "LAPORAN REKAP DATA ABSEN PEGAWAI BULAN DESEMBER TAHUN  " . $_POST['tahun'] . " ";
	}
...
while ($data = mysqli_fetch_row($hasil)) {
	...
	$hasilijincuti = mysqli_query($mysqli, "SELECT count(*) as jum FROM absensi WHERE nip = '$nip' and month(tanggal_absen)='$p_bulan' and year(tanggal_absen)='$p_tahun' and id_ijin='3' ");
	$datacuti = mysqli_fetch_row($hasilijincuti);
	$jumlahijincuti = $datacuti[0];

	$hasilcuti = mysqli_query($mysqli, "SELECT  sum(lama_cuti) as jum FROM ajuancuti WHERE month(tgl_mulai)='$p_bulan' and year(tgl_mulai)='$p_tahun' and nip='$nip'");
