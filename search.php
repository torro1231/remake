            ...
            <div class="widget-body">
                <div class="widget-main">
                    ...
                    <form class="form-horizontal" method="post" action="hasil.php">
                        ...
                        <!-- penempatan -->
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="n_jab">Penempatan :</label>
                            <div class="col-sm-9">
                                <select name="idgol" id="idgol" class="" value="">
                                    ...
                                    while ($a = mysqli_fetch_array($q)) {
                                        if ($a[0] == "") {
                                            echo "<option value='$a[0]' selected>$a[2]</option>";
                                        } else {
                        ...
                        <!-- Kordinator -->
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right">Kordinator :</label>
                            <div class="col-sm-9">
