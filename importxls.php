...
?>
    <div class="col-xs-12 col-sm-12 widget-container-col">
                ...
                <div class="widget-main padding-6">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        for ($i = 2; $i <= $baris; $i++) {
                            ...
                            $tgl_kontrak    = $data->val($i, 27);
                            $penempatan    = $data->val($i, 28);
        ...
        idjns,nmkepakaran,kd_sub,id_gol,nidn,id_stsk,tgl_kontrak,klien)
        values('$nip','$nama','$tempat_lahir','$tanggal_lahir','$jenisk','$alamat','$tgl_masuk','$id_bag','$id_jab','$tlpn','$nohp','$npwp',
        '$id_agm','$kdpndidik','$noktp','$norek','$id_bank','$kdstatusk','$kdstatusp','$tgl_jab','$id_jns','$kdkpkrn','$kd_sub','$id_gol','$nidn','$idstatusk','$tgl_kontrak','$penempatan')";
