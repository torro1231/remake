...
$aColumns = array('id', 'nip', 'n_jab', 'nama', 'nohp', 'tgl_masuk', 'klien');
...
$sJoin2 = 'left join klien b ON a.id_klien=b.kd_klien';
...
if (!empty($aOrderingRules)) {
	...
	$sOrder = " ORDER BY tgl_masuk DESC";
}
...
while ($aRow = $rResult->fetch_assoc()) {
	...
	$row = array($aRow['nip'], $aRow['nama'], $aRow['n_jab'], $aRow['nohp'], $aRow['tgl_masuk'],$aRow['klien'], $btn);
