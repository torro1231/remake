...
where pegawai.id=$iduser");
                ...
                if ($j_data == 0) {
                    ...
                    echo "<div class='profile-info-value'>";
                    echo "<span class='editable'>" . $b['tlpn'] . " / No.Hp." . $b['nohp'] . " / No Darurat." . $b['nofax'] . " </span>";
                    echo "</div>";
                    echo "</div>";
                    echo "<div class='profile-info-row'>";
                    ...
                    echo "<div class='profile-info-value'>";
                    echo "<span>Nama Bank :<b> " . $b['nm_bank'] . "</b>| Norekening :<b> " . $b['norek'] . "</b>|No.NPWP:<b> " . $b['npwp'] . "</b>|No.BPJS TK:<b> " . $b['nojamsos'] . "</b>|No.BPJS KES:<b> " . $b['nodplk'] . "</b></span>";
                    echo "</div>";
                    echo "</div>";
                    ...
                    <th>No.SK</th>
                    <th>Jabatan</th>
                    <th>Unit Bisnis Kerja</th>
                    <th>Tempat Kerja/Proyek</th>
                    <th>Renc</th>
                    <th>Real</th>
                    <th>Nama Atasan</th>
                    ...
                    if ($j_data == 0) {
                        ...
                        while ($a_pen = mysqli_fetch_array($q_pen)) {
                            echo "<tr>
                            <td>$no</td>
                            <td>$a_pen[tgl_awal]</td>
                            <td>$a_pen[tgl_akhir]</td>
                            <td>$a_pen[no_sk]</td>
                            <td>$a_pen[jabatan]</td>
                            <td>$a_pen[unit_kerja]</td>
                            <td>$a_pen[tempat]</td>
                            <td>$a_pen[d_renc]</td>
                            <td>$a_pen[d_real]</td>
                            <td>$a_pen[nm_atasan]</td>
                            <td>$a_pen[jb_atasan]</td>
						</tr>";
                            $no++;
                        }
                    }
                    ...
                    WHERE a.id = $iduser ORDER BY a.idp ASC") or die(mysqli_error($mysqli));
...
where a.id=$iduser");
                            ...
                            <form class="form-horizontal" name="form" id="valid-profil" method="post" action="" enctype="multipart/form-data">
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content profile-edit-tab-content">
                                        <div id="edit-basic" class="tab-pane in active">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-first">No Darurat</label>
                                ...
                                <div class="clearfix form-actions">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><input class="width-35 pull-right btn btn-sm btn-primary" type="submit" name="tb_act" value="UPDATE"></td>
                                    </tr>
