    ...
    <div class="col-xs-12 col-sm-6 widget-container-col">
        <div class="widget-box widget-color-orange collapsed">
            <div class="widget-header widget-header-small">
                <h6 class="widget-title">
                    <i class="ace-icon fa fa-sort"></i>
                    Rekapitulasi Berdasarkan Klien
                </h6>
            ...
            <div class="widget-body">
                <div class="widget-main">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                        <?php
                        echo "<tr><th>NO</th><th>KLIEN</th><th>L</th><th>P</th><th>JUMLAH PEGAWAI</th>";

                        $noklien = 1;
                        $totalPegawaiklien = 0;

                        $hasil = mysqli_query($mysqli, "SELECT * FROM klien");
                        while ($data = mysqli_fetch_row($hasil)) {
                            ...
                            $hasilklien = mysqli_query($mysqli, "SELECT count(*) as jum FROM pegawai WHERE klien = '$kodeklien'");
                            $dataklien = mysqli_fetch_row($hasilklien);
                            $jumlahklien = $dataklien[0];

                            $hasillakiklien = mysqli_query($mysqli, "SELECT count(*) as laki FROM pegawai WHERE jenis_kelamin='L' and klien = '$kodeklien'");
                            $datalakiklien = mysqli_fetch_row($hasillakiklien);
                            $jumlahlakiklien = $datalakiklien[0];

                            $hasilPklien = mysqli_query($mysqli, "SELECT count(*) as P FROM pegawai WHERE jenis_kelamin='P' and klien = '$kodeklien'");
                            $dataPklien = mysqli_fetch_row($hasilPklien);
                            $jumlahPklien = $dataPklien[0];

                            $totalpegawaiklien += $jumlahklien;
                            $totallakiklien += $jumlahlakiklien;
                            $totalPklien += $jumlahPklien;


                            echo "<tr><td>" . $noklien . "</td><td>" . $klien . "</td><td>" . $jumlahlakiklien . "</td><td>" . $jumlahPklien . "</td><td>" . $jumlahklien . "&nbsp Pegawai</td>";


                            $noklien++;
                        }

                        echo "<tr><td colspan='2'>JUMLAH</td><td>" . $totallakiklien . "</td><td>" . $totalPklien . "</td><td>" . $totalpegawaiklien . "&nbsp Pegawai</td>";
