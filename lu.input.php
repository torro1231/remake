...
if ($sesi_username != NULL && !empty($sesi_username) && $_SESSION['leveluser'] == '1') {
    ...
    if ($id_user == 0) {
        mysqli_query($mysqli, "INSERT INTO tbl_user (username,pass,level_user,email,id,nip,id_jab,status,kd_approve,photo) VALUES('$username','$passhash','$level_user','$email','$idp','$nippegawai','$id_jab','1','1','examples/cigs.png')");
    } else {
