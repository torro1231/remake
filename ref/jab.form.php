...
?>
	...
	<form class="form-horizontal" id="form-jab">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="kode" class="input-medium" name="kode" value="<?php echo $kode ?>" required>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="n_jab" class="input-medium" name="n_jab" value="<?php echo $n_jab ?>" required>
			</div>
		</div>
