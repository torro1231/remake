...
if ($tb_act == "Tambah") {
	$display = "style='display: none'";
	$q_tambah_agama	= mysqli_query($mysqli, "INSERT INTO bagian VALUES ('0','$p_kode_bag','$p_nama_bag')");
	if ($q_tambah_agama) {
...
<div class="module_content">
	...
	$q_bagian 	= mysqli_query($mysqli, "SELECT * FROM bagian ORDER BY id_bag ASC") or die(mysqli_error($mysqli));
...
<div <?php echo $display; ?>>
	<header>
		<h3 class="header smaller lighter blue"><?php echo $view; ?> Data Bagian</h3>
	</header>
