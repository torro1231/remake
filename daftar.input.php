...
if ($cek_username > 0) {
	...
	echo "<div id='gagal' class='alert alert-danger'>Mohon maaf Email anda Sudah terdaftar<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button></div>";
	...
	$inputuser = mysqli_query($mysqli, "INSERT INTO tbl_user( username,
                                 pass,
                                 email,
