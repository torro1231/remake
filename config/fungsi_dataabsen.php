<script type="text/javascript">
	...
	$(document).on('click', '.btn-modal', function() {
		...
		var latikantor = $(this).attr("data-latkantor");
		var longikantor = $(this).attr("data-longkantor");

		$(".modal-title-name").html(name);
		document.getElementById("iframe-map").innerHTML = '<iframe src="absen/map.php?latitude=' + latitude + '&longitude=' + longitude + ' &latkantor=' + latikantor + '&longkantor=' + longikantor + '" frameborder="0" width="100%" height="400px" marginwidth="0" marginheight="0" scrolling="no">';
	});
</script>