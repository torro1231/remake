...
$("#tgl_akhir").change(function(){
    ...
    $.ajax({ //mengambil jumlah libur NASIONAL dari database
        ...
        success: function(liburnasional){
			...
			var hasil = (tgl_akhir_leave - tgl_awal_leave) / (60 * 60 * 24 * 1000 ) + 1 - liburnasional - libur_sabtu_minggu ;       //   sPERHITUNGAN
            ...
            }else if($('select[name=id_cuti] option:selected').val() == '1'){
                $('#lama').val(hasil2);
